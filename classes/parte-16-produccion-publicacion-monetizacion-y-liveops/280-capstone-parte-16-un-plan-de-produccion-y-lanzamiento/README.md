...
> Parte: **16 — Producción, publicación, monetización y LiveOps** · Fuente: *Síntesis de la Parte 16 y plantillas de business plan para juegos indie*
...
1. Integrar producción, negocio, marketing, lanzamiento y LiveOps en un plan coherente.
2. Definir hitos de producción con entregables y un presupuesto realista.
3. Elegir y justificar un modelo de negocio adecuado al juego y su público.
4. Especificar la página de tienda y la estrategia de marketing previa al lanzamiento.
5. Aplicar una definition of done para verificar que el plan está completo y accionable.
...
- **Plan de producción y lanzamiento**: documento maestro que articula todas las fases del proyecto. Clave: es vivo, se actualiza con la realidad.
- **Hito (milestone)**: punto verificable con entregable concreto y fecha (ej.: vertical slice, beta, gold). Clave: mide avance real, no esfuerzo.
- **Presupuesto**: estimación de costes (tiempo, dinero, personas) del proyecto. Clave: obliga a decidir el alcance con honestidad.
- **Modelo de negocio**: forma de monetizar (premium, F2P, DLC, suscripción). Clave: condiciona diseño, marketing y LiveOps.
- **Página de tienda**: escaparate con cápsula, tráiler, descripción y capturas. Clave: principal punto de conversión de wishlist a venta.
- **Marketing beat**: cada acción planificada de difusión (anuncio, demo, festival). Clave: se secuencia para acumular wishlists hacia el launch.
- **Definition of Done (DoD)**: lista de criterios que definen "terminado" para un entregable. Clave: elimina la ambigüedad de "casi listo".
- **Vertical slice**: fragmento pequeño pero pulido que representa el juego final. Clave: prueba la visión y sirve para marketing.
...
1. **Portada y visión.** Nombre, género, plataforma(s), pitch en una frase, público objetivo y visión en un párrafo. Define el **alcance** (qué incluye y, sobre todo, qué NO).

2. **Producción: hitos y cronograma.** Lista los hitos con entregable y fecha estimada:
...
3. **Presupuesto.** Estima costes por categoría (personas/horas, assets, música, herramientas, marketing, fees de plataforma) y una reserva de contingencia. Aunque seas un equipo de una persona, cuantifica el tiempo como coste.

4. **Modelo de negocio.** Elige (premium, F2P con IAP, DLC, etc.), justifica por qué encaja con tu juego y público, y define precio o estructura de monetización. Conéctalo con el LiveOps de la clase 277 si aplica.

5. **Marketing y página de tienda.** Traza un calendario de marketing beats hacia el lanzamiento (anuncio, demo, festival, tráiler) con objetivo de wishlists. Especifica la página de tienda: cápsula, descripción, 5–8 capturas, tráiler, etiquetas.

6. **Plan de lanzamiento y post-lanzamiento.** Integra la checklist de la clase 276, el plan de soporte de 90 días (279) y el plan de telemetría (278) como anexos o referencias. Cierra con la **Definition of Done del plan** y una **checklist de completitud** que valide que todas las secciones existen y son accionables.

7. **Ensambla y revisa** contra tu propia DoD. Usa esta checklist de completitud como guía final antes de entregar:
...
1. Escribe el pitch de tu juego en una sola frase y en 280 caracteres para redes.
2. Reduce el alcance de tu plan en un 20% eliminando features y justifica qué se corta primero.
3. Estima el presupuesto de marketing como porcentaje del total y explica el reparto.
4. Diseña la cápsula y el titular de la página de tienda que maximicen el clic.
5. Define tres hitos con su criterio de "done" inequívoco.
6. Escribe la Definition of Done del plan completo: ¿cuándo consideras el documento terminado?
