# Clase 271 — Marketing y construcción de comunidad

> Parte: **16 — Producción, publicación, monetización y LiveOps** · Fuente: *Chris Zukowski, How To Market A Game*
...
- Identificar el hook de un juego y comunicarlo en una imagen y una frase.
- Diseñar los elementos de una cápsula de tienda que capte atención.
- Construir y nutrir una comunidad en Discord, redes y devlogs.
- Planificar contactos con prensa e influencers de forma efectiva.
- Elaborar un plan de marketing de tres meses con hitos y canales.
...
- **Hook**: el gancho único que hace memorable al juego. Clave: debe entenderse en una frase y una imagen.
- **Cápsula (capsule art)**: la imagen-miniatura del juego en la tienda. Clave: legible en pequeño, con foco claro, decide el clic.
- **Comunidad**: grupo de seguidores comprometidos (Discord, redes). Clave: se cultiva a largo plazo, no se compra.
- **Devlog**: registro público del desarrollo (video, post, hilo). Clave: convierte el progreso en contenido y engagement.
- **Wishlist**: lista de deseos en Steam. Clave: es el objetivo central del marketing pre-lanzamiento.
- **Press kit**: paquete con info, capturas, tráiler y contacto para prensa. Clave: facilita que te cubran; hazlo fácil de usar.
- **Influencer/creador**: streamer o youtuber que muestra el juego. Clave: su audiencia adecuada vale más que su tamaño.
- **Beat/hito de marketing**: momento con anuncio (reveal, demo, tráiler). Clave: da ritmo y razones para volver a hablar.

## 🧰 Herramientas y preparación

Prepara cuentas en las redes donde esté tu público (X, Bluesky, TikTok, YouTube, Reddit) y un [Discord](https://discord.com/) para tu comunidad. Para la cápsula usa una herramienta de diseño (Photoshop, Figma, Canva). Referencia central: el blog de [Chris Zukowski, How To Market A Game](https://howtomarketagame.com/). No hay código. Ten identificados tu género y público objetivo. Investiga qué creadores cubren juegos como el tuyo y prepara una lista.
...
- [ ] El hook se entiende en una sola frase, sin jerga interna.
- [ ] La cápsula tiene un foco visual claro y legible en miniatura.
- [ ] El calendario cubre 12 semanas con un objetivo medible por mes.
- [ ] Los contactos son reales y están justificados por encaje de nicho.
- [ ] El email de presentación es breve y personalizable, no genérico.
...
1. Escribe el hook de tu juego en una frase y en una imagen conceptual.
2. Critica la cápsula de un juego real: qué funciona y qué no.
3. Diseña la estructura de canales de tu servidor de Discord.
4. Redacta el guion de un devlog de un minuto sobre una feature.
5. Escribe un email de presentación a un creador (máx. 6 líneas).
6. Fija tres objetivos de wishlists medibles para tres meses.
