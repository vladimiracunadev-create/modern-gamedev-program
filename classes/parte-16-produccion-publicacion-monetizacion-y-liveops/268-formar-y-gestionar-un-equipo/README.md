...
- Describir los roles principales de un equipo de desarrollo y sus responsabilidades.
- Decidir la composición mínima viable de un equipo según el proyecto.
- Comparar dinámicas de equipos pequeños frente a grandes.
- Seleccionar herramientas de gestión y comunicación adecuadas.
- Definir prácticas de cultura sana que prevengan el crunch.
...
- **Rol**: conjunto de responsabilidades de una disciplina (programación, arte, diseño, audio, producción). Clave: no equivale a una persona; alguien puede cubrir varios.
- **Productor**: quien coordina personas, tiempos y comunicación, no quien decide el diseño. Clave: elimina bloqueos y protege el foco del equipo.
- **Equipo pequeño (1-5)**: alta velocidad y comunicación directa, poca especialización. Clave: cada rol crítico debe estar cubierto por alguien.
- **Equipo grande (10+)**: capacidad para escalar contenido, mayor coste de coordinación. Clave: necesita procesos formales y leads por disciplina.
- **Lead**: responsable técnico/creativo de una disciplina. Clave: filtra decisiones y mentoriza al resto.
- **Crunch**: periodos sostenidos de horas extra para cumplir plazos. Clave: síntoma de mala planificación, no de compromiso.
- **Stand-up**: reunión breve diaria de sincronización. Clave: qué hice, qué haré, qué me bloquea; máximo 15 minutos.
- **Kanban/Scrum board**: tablero visual del trabajo en columnas. Clave: hace visible el estado y los cuellos de botella.

## 🧰 Herramientas y preparación

Prepara cuentas gratuitas en una herramienta de tareas ([Trello](https://trello.com/), [Jira](https://www.atlassian.com/software/jira) o GitHub Projects) y en un canal de comunicación ([Discord](https://discord.com/) o Slack). Para documentación compartida sirve Notion, Google Docs o un wiki. No se escribe código en esta clase. Ten claro el alcance de tu proyecto (de la Clase 267) para dimensionar el equipo. Revisa material sobre prevención de crunch en charlas de la [GDC](https://www.gdcvault.com/).
...
- [ ] Las cinco disciplinas están cubiertas o su ausencia está justificada.
- [ ] Cada rol tiene responsabilidades concretas, no etiquetas vagas.
- [ ] El tablero tiene columnas que reflejan tu flujo real de trabajo.
- [ ] Las reuniones tienen objetivo y duración máxima definidos.
- [ ] Existe al menos una mitigación para cada punto único de fallo.

## ✍️ Ejercicios

Aplícalos a tu proyecto real: el objetivo es que salgas con un equipo y unos procesos que podrías poner en marcha mañana.

1. Lista las cinco disciplinas y una responsabilidad concreta de cada una en tu juego.
2. Diseña un equipo de tres personas: reparte los cinco roles entre ellas.
3. Redacta la agenda de un stand-up y su duración máxima.
4. Compara: enumera dos ventajas y dos riesgos de un equipo de 2 frente a uno de 12.
5. Escribe una política de crunch de tu equipo en tres frases.
6. Diseña la estructura de columnas de tu tablero kanban.
