...
> Parte: **16 — Producción, publicación, monetización y LiveOps** · Fuente: *Heather Maxwell Chandler, The Game Production Toolbox*
...
- Comparar autofinanciación, publisher, grants y crowdfunding según control y riesgo.
- Explicar qué aporta y qué exige un publisher a cambio de financiar.
- Identificar fuentes de grants y sus requisitos típicos.
- Estructurar los elementos de una campaña de crowdfunding realista.
- Elaborar un pitch de una página y un presupuesto básico de proyecto.
...
- **Bootstrapping**: financiar con recursos propios o ingresos. Clave: conservas el 100% de control e IP, pero asumes todo el riesgo.
- **Publisher**: empresa que financia y comercializa a cambio de un porcentaje. Clave: aporta marketing y alcance; negocia bien el reparto y la IP.
- **Revenue share**: porcentaje de ingresos que se lleva el publisher hasta recuperar (recoup) su inversión y después. Clave: entiende el orden de recoup.
- **Grant**: subvención que no se devuelve ni diluye propiedad. Clave: suele exigir requisitos regionales, informes y cofinanciación.
- **Crowdfunding**: financiación colectiva a cambio de recompensas. Clave: campaña pública que también valida el interés del mercado.
- **Pitch deck**: presentación breve que vende el proyecto. Clave: hook, gameplay, mercado, equipo y necesidad de financiación.
- **Burn rate**: gasto mensual del proyecto. Clave: junto al capital determina el runway (meses de vida).
- **Recoup**: recuperación de la inversión del publisher antes de repartir beneficios. Clave: define cuándo empiezas a cobrar tú.

## 🧰 Herramientas y preparación

Necesitas una hoja de cálculo para el presupuesto y una herramienta de presentación (Google Slides, PowerPoint o Canva) para el pitch. No hay código. Investiga fuentes de grants de tu región y programas privados. Referencias útiles: la [guía de Kickstarter para creadores](https://www.kickstarter.com/learn), recursos de pitch de publishers indie, y charlas de financiación en la [GDC](https://www.gdcvault.com/). Ten a mano tu vertical slice o prototipo: sin algo jugable, casi nadie financia.
...
1. **Título y hook** (una frase que engancha).
2. **Qué es** (género, plataformas, referentes "X con Y").
3. **Gameplay** (2-3 mecánicas clave con una imagen o mockup).
4. **Mercado y público objetivo**.
5. **Equipo** (quién y por qué puede lograrlo).
6. **Estado y plan** (qué tienes hecho, qué falta, fechas).
7. **La pregunta** (cuánto necesitas y para qué).
...
- [ ] El pitch abre con un hook, no con una lista de características.
- [ ] El presupuesto incluye contingencia y suma sin errores.
- [ ] El runway está expresado en meses y es realista.
- [ ] Hay tres escenarios o al menos una banda de incertidumbre.
- [ ] La vía de financiación elegida se compara con una alternativa.
...
1. Escribe el hook de tu juego en una sola frase memorable.
2. Compara para tu proyecto: dos pros y dos contras de publisher vs crowdfunding.
3. Busca una grant real aplicable a tu región y lista tres de sus requisitos.
4. Diseña tres niveles de recompensa (tiers) para una campaña de crowdfunding.
5. Calcula el runway de un proyecto con 30.000 de capital y 5.000/mes de burn.
6. Redacta la diapositiva "la pregunta" con la cantidad y su justificación.
