...
- Construir un presupuesto y un flujo de caja básicos para un proyecto.
- Identificar las cláusulas clave de contratos con colaboradores y proveedores.
- Distinguir tipos de licencia de assets, música y fuentes.
- Reconocer riesgos de marcas y copyright y cómo evitarlos.
- Elaborar una checklist legal y de licencias para un juego.
...
- **Presupuesto**: estimación de costes por categoría y total. Clave: incluye contingencia y se revisa periódicamente.
- **Flujo de caja**: entradas y salidas de dinero en el tiempo. Clave: puedes ser rentable y aun así quedarte sin liquidez.
- **Contrato de colaborador**: acuerdo que fija pago, alcance y propiedad. Clave: define quién es dueño del trabajo entregado (work-for-hire).
- **Licencia de asset**: permiso de uso de un recurso (arte, sonido). Clave: verifica alcance comercial, atribución y exclusividad.
- **Royalty-free**: se paga una vez y se usa sin regalías recurrentes. Clave: no significa gratis ni sin condiciones.
- **Creative Commons**: familia de licencias con distintas condiciones (BY, NC, SA). Clave: NC prohíbe uso comercial; lee la variante.
- **Marca (trademark)**: protege nombres y logos comerciales. Clave: verifica que tu título no infringe marcas registradas.
- **Copyright**: derecho automático sobre obras originales. Clave: no uses material ajeno sin licencia, aunque no lleve símbolo.

## 🧰 Herramientas y preparación

Usa una hoja de cálculo para presupuesto y flujo de caja. No hay código. Ten a mano el listado de assets, música y fuentes que usa tu juego con su origen. Consulta las licencias en las tiendas de assets ([Unity Asset Store](https://assetstore.unity.com/), [Unreal Marketplace](https://www.fab.com/), [itch.io](https://itch.io/game-assets)) y en fuentes de música/SFX. Para marcas, revisa buscadores oficiales de tu país. Esta clase no es asesoría legal: para contratos reales, consulta a un profesional.
...
- [ ] El presupuesto suma correctamente e incluye contingencia.
- [ ] El flujo de caja muestra cuándo entra y sale el dinero, no solo el total.
- [ ] Cada asset/música/fuente tiene su licencia y alcance comercial verificados.
- [ ] Las atribuciones requeridas están anotadas.
- [ ] El título se ha comprobado frente a marcas y hay evidencia de cada licencia.
...
1. Clasifica tres assets según su tipo de licencia y si permiten uso comercial.
2. Redacta las tres cláusulas mínimas de un contrato con un músico.
3. Calcula el total de un presupuesto con 15% de contingencia sobre 20.000.
4. Verifica si una fuente tipográfica permite uso comercial y embebido.
5. Comprueba si un título tentativo choca con alguna marca conocida.
6. Traza el flujo de caja de un proyecto de 6 meses con un pago grande en el mes 4.
