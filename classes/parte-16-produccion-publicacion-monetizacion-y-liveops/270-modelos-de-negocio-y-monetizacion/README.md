...
- Distinguir los modelos premium, F2P, DLC, suscripción y battle pass.
- Calcular e interpretar métricas como ARPU y LTV.
- Elegir un modelo de monetización coherente con el diseño del juego.
- Diferenciar monetización ética de patrones oscuros.
- Estimar ingresos a partir de supuestos de audiencia y conversión.
...
- **Premium**: pago único para acceder al juego completo. Clave: conversión clara, techo de ingresos limitado por ventas.
- **Free-to-play (F2P)**: gratis con monetización interna (cosméticos, moneda). Clave: solo un pequeño porcentaje paga; el diseño debe retener.
- **DLC/expansión**: contenido adicional de pago sobre el juego base. Clave: recompensa a fans y alarga el ciclo de ingresos.
- **Suscripción**: pago recurrente por acceso o contenido. Clave: exige flujo constante de valor para evitar churn.
- **Battle pass**: progresión estacional de recompensas, gratis y premium. Clave: monetiza el engagement sin bloquear la jugabilidad.
- **ARPU**: ingreso medio por usuario (ingresos / usuarios). Clave: mide monetización global, no solo de quienes pagan.
- **LTV (lifetime value)**: ingreso total esperado por jugador durante su vida útil. Clave: guía cuánto puedes gastar en adquirirlo.
- **Patrón oscuro**: diseño que manipula al usuario para que gaste (pay-to-win, FOMO agresivo). Clave: rinde a corto plazo y destruye confianza a largo.

## 🧰 Herramientas y preparación

Usa una hoja de cálculo para el modelo de ingresos y para las métricas. No se programa. Familiarízate con los términos ARPU, LTV, conversión y churn. Referencias: análisis de monetización en [GameAnalytics](https://gameanalytics.com/blog) y charlas de negocio de la [GDC](https://www.gdcvault.com/). Ten claro tu género y público (clases anteriores) porque condicionan qué modelos son viables. Reflexiona sobre las regulaciones de loot boxes en varios países.
...
- [ ] La matriz puntúa los cinco modelos con el mismo criterio.
- [ ] El modelo ganador es coherente con el género y el público.
- [ ] La estimación descuenta la comisión de tienda.
- [ ] Cada supuesto (audiencia, precio, conversión) está escrito y es justificable.
- [ ] El modelo no depende de patrones oscuros para ser rentable.

## ✍️ Ejercicios

Combina cálculo y criterio: estos ejercicios te piden tanto operar métricas como defender decisiones de modelo y de ética.

1. Asigna un modelo de monetización a tres juegos que conozcas y justifica por qué.
2. Calcula el ARPU de un juego con 10.000 usuarios y 25.000 de ingresos.
3. Explica un patrón oscuro y propón una alternativa ética que monetice igual.
4. Diseña las recompensas gratuitas y premium de un battle pass de una temporada.
5. Calcula ingresos netos de 5.000 ventas a 15 con comisión del 30%.
6. Estima el LTV si un jugador aporta 2/mes durante 8 meses de media.
