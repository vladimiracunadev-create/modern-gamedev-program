...
> Parte: **17 — Capstones y preparación profesional / portfolio** · Fuente: *Game jams: Global Game Jam, Ludum Dare y GMTK Game Jam*
...
- Explicar el valor profesional de participar en game jams.
- Elegir una jam adecuada a su nivel y objetivos.
- Planificar el scope de una jam de 48 horas con roles y herramientas.
- Ejecutar una estrategia de jam que priorice terminar sobre ampliar.
- Escribir un post-mortem que convierta la experiencia en aprendizaje.
...
- **Game jam**: evento para crear un juego en un tiempo limitado bajo un tema. Clave: terminar algo jugable importa más que la perfección.
- **Tema (theme)**: consigna que arranca la jam y guía la idea. Clave: interprétalo pronto y no lo sobreanalices.
- **Scope de jam**: alcance recortado a lo que cabe en 48 h. Clave: un core loop simple y pulible, nada de sistemas grandes.
- **MVP jugable**: versión mínima que ya se juega de principio a fin. Clave: llega a jugable pronto y pule con el tiempo restante.
- **Roles de equipo**: reparto de tareas (código, arte, audio, diseño). Clave: acordarlos antes evita solapes y vacíos.
- **Vertical de jam**: recorte pequeño y presentable como pieza de portfolio. Clave: sirve incluso si el juego es breve.
- **Post-mortem**: análisis de qué salió bien y mal tras la jam. Clave: convierte la experiencia en lecciones reutilizables.
- **Del prototipo al proyecto**: expandir una idea de jam que funcionó. Clave: solo si el core loop demostró ser divertido.

## 🧰 Herramientas y preparación

Necesitas un motor que domines (para no perder tiempo aprendiendo durante la jam), assets de emergencia (fuentes, sonidos y sprites con licencia libre) y una cuenta en la plataforma de la jam. Las jams clásicas son [Global Game Jam](https://globalgamejam.org/) (presencial y por equipos), [Ludum Dare](https://ldjam.com/) (online, con modalidad en solitario) y la [GMTK Game Jam](https://itch.io/jams) (online, temática de diseño). Prepara tu entorno y una plantilla de proyecto vacía antes de que empiece. Para publicar rápido, [itch.io](https://itch.io/) es el estándar. Ten a mano bibliotecas de audio y arte con licencia clara.
...
- Qué salió bien (3 puntos)
- Qué salió mal (3 puntos)
- Qué haría distinto la próxima vez
- ¿Merece expandirse a proyecto? Por qué
...
- [ ] Motor, plantilla y assets de emergencia listos antes de empezar
- [ ] Core loop definido en las primeras horas tras conocer el tema
- [ ] Versión jugable de principio a fin antes de la mitad del tiempo
- [ ] Descanso y sueño planificados (no todo de un tirón)
- [ ] Últimas horas reservadas para exportar y subir la build
- [ ] Juego publicado en la plataforma antes del cierre
- [ ] Post-mortem escrito el mismo día, con la experiencia fresca
